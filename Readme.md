...
* Студент: [Рамила](https://up.htmlacademy.ru/htmlcss/32/user/1845655).
* Наставник: `Неизвестно`.
* Наставник: `Сергей Дубин`.
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1845655-sedona-32) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
